...
const dogIntro = function (treat, toy) {
    return `${this.name} is a ${this.breed} that loves ${treat} an their ${toy}!`
}
/*
...
//CODE HERE
let phone1 = new Phone('Samsung', 'galaxy', 258, 'gold', false)

let phone2 = new Phone('Apple', 'apple', 215, 'red', false)

let phone3 = new Phone('Samsung', 'samsung', 300, 'blue', false)
